...
const servicio = { 
 ...
 if (!e.ci) return responder({ code: grpc.status.INVALID_ARGUMENT, 
 ...
 if (!e) return responder({ code: grpc.status.NOT_FOUND, 
...
servidor.bindAsync(DIR, grpc.ServerCredentials.createInsecure(), 
 (err, puerto) => { 
